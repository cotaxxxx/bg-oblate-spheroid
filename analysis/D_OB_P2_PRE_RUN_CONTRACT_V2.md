# D-OB P2 PRE-RUN CONTRACT V2

**Status**: `SEALED / NOT_RUN / NOT_BINDING`

**Base.** Branch `design/d-ob-p2`. Specification `analysis/D_OB_P2_CERTIFICATION_SPEC_V2.md`, blob `b14c0f6eb7b2d3d2e4794a1184dfe53f1660840c`, SHA-256 `19af6f7f4aa68771707bc3ffe1abf06fabbbc3098b4bfe0710db00631b8bb069`, cited below as SPEC. This contract fixes how SPEC is executed; it changes nothing in SPEC.

**Supersedes.** CONTRACT V1 (`analysis/D_OB_P2_PRE_RUN_CONTRACT_V1.md`, commit `7afcddd7`, SHA-256 `2e7d85bd916bee6ed315c7b42fb79e591b1430e099fb9b17418a8beb8283ec53`), which referred to SPEC V1. This version refers to SPEC V2 and is otherwise unchanged.
